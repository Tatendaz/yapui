...
| 📸 Snap fails with "Screenshot needs internet" | `html2canvas` is fetched from a CDN the first time you snap. Offline, typing, picking and recording still work — 🎙 Talk needs the browser's online speech service too. |
